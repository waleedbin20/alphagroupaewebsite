...
const SuccessAlert = ({ message, message1 }) => {
    return (
        <>
            <div className="py-10 bg-[#e9a0211a] dark:bg-titlebgdark">
                <div className="container">
                    <div className="border-green bg-green-light-6 flex w-full rounded-lg border-l-[6px] px-7 py-8 md:p-9">
                        ...
                        <div className="w-full">
                            <h5 className="mb-3 text-lg font-semibold text-[#1d144d] dark:text-white">
                                {message}
                            </h5>
                            <p className="text-base leading-relaxed text-body-color dark:text-[#d1d1d1]">
                                {message1}
                            </p>
                        </div>
                    </div>
